...
<!-- .slide: data-background-image="/layout/img/waterski.jpg" -->
# Distributed Team
...
<!-- .slide: data-background-image="/layout/img/bread2.jpg" data-background-size="auto 100%" data-background-color="black" -->
...
![Cluster](/layout/img/cluster-highlevel.png)  <!-- .element height="90%" style="background-color: white;" -->
...
![Cluster](/layout/img/pipeline.png)  <!-- .element width="100%" style="background-color: white;" -->
