...
* Bare Metal in Frankfurt, Germany
* AWS
...
Most of the time we run multiple clusters at our customer datacenter or in their AWS accounts as well.
...
![Cluster](/layout/img/services_aws.svg)  <!-- .element width="100%" style="background-color: white;" -->

---

![Cluster](/layout/img/guest_aws.svg)  <!-- .element width="100%" style="background-color: white;" -->
...
* Certs are handed to the VMs via KMS
...
* Host cluster: AWS VPC / Calico for containers
* Guest cluster: Separate AWS VPC / Calico for containers
